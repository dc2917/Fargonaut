...
class Density(Field):
    ...
    def x(self) -> NDArray[float64]:
        """The x-coordinates at which the density is defined.
    ...
    def y(self) -> NDArray[float64]:
        """The y-coordinates at which the density is defined.
    ...
    def z(self) -> NDArray[float64]:
        """The z-coordinates at which the density is defined.
    ...
    def raw(self) -> NDArray[float64]:
        ...
        Returns:
            NDArray: A 1D numpy array containing the density values
        """
        return self._raw
    ...
    def data(self) -> NDArray[float64]:
        ...
        Returns:
            NDArray: A shaped numpy array containing the density values
        """
        return self._data
